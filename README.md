...
* **Group Variable (群組變數):** SadOrHopeless (Recoded: 1 = Felt sad or hopeless, 0 = Did not feel sad or hopeless)
* **Response Variable (反應變數):** CurrentCigaretteUse (Recoded: 1 = Current user, 0 = Non-user)

## Methodology & Conclusion
* **Method Used (使用的統計方法):** Two-proportion z-test
* **Short Final Conclusion (簡短結論):** [待分析完成後，請在此填寫簡短結論，例如：感到悲傷或絕望的學生中，目前吸菸的比例顯著高於未感到悲傷或絕望的學生。]
